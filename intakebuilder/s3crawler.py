...
class S3Crawler:
    ...
    def __init__(self):
        print("Initializing SSS crawler")

    def crawl(self, projectdir: str, dictFilter: dict, project_root: str, logger):
        region = 'us-west-2'
            ...
            for prefixes in result.get('CommonPrefixes'):
                ...
                if pat is not None:
                    ...
                    if m is not None:
                        ...
                        # Using YAML instead of this to get frequency and modeling_realm  dictInfo =
                        # getinfo.getInfoFromGlobalAtts(filepath, dictInfo) TODO YAML for all mip_tables
