...
class LocalCrawler:
    ...
    """
    def __init__(self):
        print("Initializing localCrawler")

    def crawl(self, projectdir: str, dictFilter: dict, logger):
        """
        ...
        for dirpath, dirs, files in os.walk(projectdir):
            ...
            if dictFilter["source_prefix"] in dirpath:  # T ODO improved filtering
                searchpath = dirpath
                if orig_pat is None:
                ...
                if pat is not None:
                    ...
                    for filename in files:
                        ...
                        filepath = os.path.join(dirpath,
                                                filename)  # 1 AR: Bugfix: this needs to join dirpath and filename to get
                        ...
                        if dictInfo["model"] in list_bad_modellabel:
                            logger.debug("Found experiment name in model column, skipping this possibly bad DRS "
                                         "filename",
